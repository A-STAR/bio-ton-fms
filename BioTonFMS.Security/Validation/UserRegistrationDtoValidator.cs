...
public class UserRegistrationDtoValidator : AbstractValidator<UserRegistrationDto>
{
    public UserRegistrationDtoValidator()
    {
        ...
        RuleFor(x => x.UserName).NotEmpty().MaximumLength(20).Matches("^[А-Яа-яa-zA-Z0-9-._@+]*$").WithMessage("Логин имеет неверный формат, поле допускает использование русских и латинских букв, цифр, символов '-','_','.','@','+'");
