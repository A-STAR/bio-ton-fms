...
namespace BioTonFMS.MessagesMigrations.Migrations
{
    ...
    [Migration("20240321162245_AddTrackerMessagePackageUIDIndex")]
    partial class AddTrackerMessagePackageUIDIndex
    {
            ...
            modelBuilder.Entity("BioTonFMS.Domain.TrackerMessages.TrackerMessage", b =>
                {
                    ...
                    b.HasIndex("PackageUID")
                        .HasDatabaseName("ix_tracker_messages_package_uid");
