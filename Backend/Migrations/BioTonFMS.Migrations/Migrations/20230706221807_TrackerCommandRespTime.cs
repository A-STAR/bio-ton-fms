...
{
    public partial class TrackerCommandRespTime : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sent_date_time = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    command_text = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    response_text = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    binary_response = table.Column<byte[]>(type: "bytea", maxLength: 200, nullable: false),
                    response_date_time = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
