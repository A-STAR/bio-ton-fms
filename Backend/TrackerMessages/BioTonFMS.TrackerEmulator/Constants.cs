...
- C двумя параметрами -i|--message <message_file> -o|--result <result_file>.
...
- C тремя параметрами -i|--message <message_file> -o|--result <result_file> -r|--repeat <repeat_count>.
...
- C одним параметром -s|--script <script_file>.
